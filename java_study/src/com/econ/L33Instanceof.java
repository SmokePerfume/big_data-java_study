...
public class L33Instanceof {
	public static void main(String[] args) {
		...
		System.out.println(c instanceof Personable); //type비교
		
		//"객체" instanceof "type" 는 참조형 객체의 비교 연산자
		///////!!!!자베에서 기본데이터 타압의 data의 타입을 확인할 방법이 엇다.
		...
		//모든 객체의 부모인 Object에 모든 타입의 객체를 참조할 수 있지만 Object 필드만 사용가능
