...
class Person{
	int a=10;
	int b; //필드는 undefined일 수 ㅇ벗어 선언시 값을 준다. int : 0;
	boolean c; //false
	double d;
	String s; //참조형은 null을 대입
	Scanner sc;
	Person(){
		//부모의 class 필드를 접근하는 접근자는 super
		//부모의 자언(필드)를 상속받으면 내것이 되기 때문에 this기도 하다.
...
public class L23Field {
	...
	public static void main(String[] args) {
		...
		//최상위 설계도의 type(이름)은 java.lang.Object (Object)이고 Object 필드를 사용할 수 있(상속).
		Person p= new Person();
		...
		System.out.println("p.sc(Scanner)="+p.sc);
