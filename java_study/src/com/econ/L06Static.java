package com.econ;
//com.econ.WIDTH (X) 대명사가 빠진 이름은 존재하지 않는다.
//public static final double WIDTH=250.01;

class Car{
	public static final double WIDTH=250.01; 
	//상수는 보통 정보 전달 목적으로 자주 사용되기 때문에 static 필드에 선언되고 어디서든 공유가능하다는 의미로 public를 선언한다.
	final double HEIGHT = 500.01;
	private final String ENGINE = "N012421"; //class 내부에서만 사용가능
}
...
public class L06Static {
	public static void main(String[] args) {
		...
		//인스턴스 객체는 new 연산자로 생성자를 호출할 때 만들어진다.
		...
		//static 필드는 class의 이름만 빌려온다. (정적 메모리라 부르는 곳에 저장됨, jre 즉 main과 기본데이터타입이 저장되는 메모리)
