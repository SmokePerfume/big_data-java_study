...
public class L09OperatorMath {
	public static void main(String[] args) {
		...
		//i-=10.6; //10.8 //대입 엽산을 사용하면 자동 형변환이 된다.
		i=(int)(i-10.6);
		System.out.println(i); //실수를 정수로 형변환 하면 소수점 버림이 된다. 10.6=>10. -0.7=>0;
		i=(int)-0.7;
		System.out.println(i);
		...
		//산술 동등 비교(기본데이터 타입 수 비교)는 값을 비교한다.
		...
		System.out.println(i==z_d);
		System.out.println(i==(int)z_d);// 위 표현은 아래와 같다
		...
		System.out.println((int)obj_i1==(int)obj_i2);
